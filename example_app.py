...
class DroneClient(QObject):
    ...
    def connect_to_drone(self, address, port):
        ...
        self.connection_status.emit(True, f"Connected to {address}:{port}")
        return True
        
    def disconnect(self):
        """Disconnect from the drone."""
        if self.connected:
            print(f"[MOCK] Disconnecting from drone at {self.tcp_address}:{self.tcp_port}")
            self.connected = False
            self.armed = False
            self.flying = False
            self.mission_active = False
    ...
    def takeoff(self, altitude):
        ...
        print(f"[MOCK] Taking off to {altitude}m")
        self.flying = True
    ...
    def return_to_home(self):
        ...
        print("[MOCK] Returning to launch")
...
class DroneControlApp(QMainWindow):
    ...
    def __init__(self):
        ...
        self.setWindowTitle("Drone Control Center")
        self.resize(900, 700)
