...
class DroneCameraWidget(QWidget):
    ...
    def create_professional_placeholder(self):
        ...
        painter.drawText(center_x - 100, center_y + 60, 200, 30, Qt.AlignCenter, "CAMERA OFFLINE")
        
        painter.setFont(QFont("Segoe UI", 12))
        painter.setPen(QPen(QColor(100, 100, 100), 1))
        painter.drawText(center_x - 120, center_y + 90, 240, 20, Qt.AlignCenter, "Click CONNECT to start video stream")
