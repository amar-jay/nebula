"""
Crane control via serial communication with Arduino.
Includes manual override and ZMQ command handling.
It isn't currently implemented in the main branch, you can check `in_flight` branch for usage example.
"""
