...
ARDU_CMD="$HOME/ardupilot/Tools/autotest/sim_vehicle.py -v ArduCopter -f gazebo-iris  --custom-location=40.9588862,29.1357976,15,0 --model JSON --console --instance=0" # --instance=1 --out=udp:127.0.0.1:14550"
#MINI_ARDU_CMD="$HOME/ardupilot/Tools/autotest/sim_vehicle.py -v ArduCopter -f gazebo-iris  --custom-location=40.9588862,29.1357976,0,0 --model JSON --console --instance=1" # --instance=1 --out=udp:127.0.0.1:14550"
