...
class Ui_IndicatorsPage(object):
	def setupUi(self, IndicatorsPage):
		if not IndicatorsPage.objectName():
			IndicatorsPage.setObjectName("IndicatorsPage")
		IndicatorsPage.resize(885, 651)
		IndicatorsPage.setMinimumSize(QSize(700, 650))
		IndicatorsPage.setStyleSheet(
			"QFrame{background-color: qlineargradient(spread:pad, x1:0.5, y1:1, x2:0.542, y2:0.0283636, stop:0.133663 rgba(30, 33, 31, 255), stop:0.816832 rgba(40, 44, 52, 255));\n"
			"border-radius: 20px;\n"
		...
		self.Vspeedometer.setObjectName("Vspeedometer")
		sizePolicy1 = QSizePolicy(QSizePolicy.Preferred, QSizePolicy.Fixed)
		sizePolicy1.setHorizontalStretch(0)
		sizePolicy1.setVerticalStretch(0)
		sizePolicy1.setHeightForWidth(
			self.Vspeedometer.sizePolicy().hasHeightForWidth()
		)
		...
		self.vspeed_label.setObjectName("vspeed_label")
		self.vspeed_label.setGeometry(QRect(20, 8, 256, 256))
		sizePolicy2 = QSizePolicy(QSizePolicy.Expanding, QSizePolicy.Expanding)
		sizePolicy2.setHorizontalStretch(1)
		sizePolicy2.setVerticalStretch(1)
		sizePolicy2.setHeightForWidth(
			self.vspeed_label.sizePolicy().hasHeightForWidth()
		)
		...
		self.vspeed_label.setPixmap(QPixmap(":/meters/assets/Vertical_Speed.png"))
		self.vspeed_label.setScaledContents(True)
		self.vspeed_label.setAlignment(Qt.AlignCenter)
		self.vspeed_label.setIndent(-1)
		self.vspeed_needle = RotatingLabel(
			"uifolder/assets/needle.png", self.Vspeedometer
		)
		self.vspeed_needle.setObjectName("vspeed_needle")
		self.vspeed_needle.setGeometry(QRect(20, 8, 256, 256))
		self.vspeed_needle.setStyleSheet("background-color: transparent")
		self.vspeed_needle.setPixmap(QPixmap(":/needles/assets/needle.png"))
		...
		self.speed_text_2.setObjectName("speed_text_2")
		self.speed_text_2.setGeometry(QRect(118, 160, 60, 30))
		self.speed_text_2.setStyleSheet(
			" color: #ffffff; font-family: 'Lato',sans-serif; font-size: 18px; font-weight: bold; text-align: center; text-transform: uppercase;"
		)
		...
		sizePolicy4.setHeightForWidth(
			self.altitude_label.sizePolicy().hasHeightForWidth()
		)
		...
		self.altitude_label.setPixmap(QPixmap(":/meters/assets/Altitude.png"))
		self.altitude_label.setScaledContents(True)
		self.altitude_needle = QLabel(self.Altitude)
		self.altitude_needle.setObjectName("altitude_needle")
		self.altitude_needle.setGeometry(QRect(0, 508, 60, 20))
		self.altitude_needle.setStyleSheet("background-color: transparent")
		self.altitude_needle.setPixmap(QPixmap(":/needles/assets/Rectangle.png"))
		...
		sizePolicy1.setHeightForWidth(
			self.AttitudeIndicator.sizePolicy().hasHeightForWidth()
		)
		...
		self.attitude_middle = RotatingLabel(
			"uifolder/assets/gyrocircle.png", self.AttitudeIndicator
		)
		self.attitude_middle.setObjectName("attitude_middle")
		self.attitude_middle.setGeometry(QRect(55, 41, 187, 187))
		self.attitude_middle.setStyleSheet("background-color: transparent")
		...
		sizePolicy.setHeightForWidth(
			self.attitude_label.sizePolicy().hasHeightForWidth()
		)
		...
		self.attitude_label.setStyleSheet("")
		self.attitude_label.setFrameShape(QFrame.NoFrame)
		self.attitude_label.setPixmap(QPixmap(":/meters/assets/Gyroscope.png"))
		...
		sizePolicy2.setHeightForWidth(
			self.direction_label.sizePolicy().hasHeightForWidth()
		)
		...
		self.direction_label.setPixmap(QPixmap(":/meters/assets/Gyrometre.png"))
		...
		self.direction_needle = RotatingLabel(
			"uifolder/assets/plane.png", self.Direction
		)
		self.direction_needle.setObjectName("direction_needle")
		self.direction_needle.setGeometry(QRect(20, 8, 252, 252))
		self.direction_needle.setStyleSheet("background-color: transparent")
		self.direction_needle.setPixmap(QPixmap(":/needles/assets/plane.png"))
		...
		self.speed_label.setPixmap(QPixmap(":/meters/assets/Speedometer.png"))
		self.speed_label.setScaledContents(True)
		self.speed_label.setAlignment(Qt.AlignCenter)
		self.speed_label.setIndent(-1)
		self.speed_needle = RotatingLabel(
			"uifolder/assets/needle.png", self.Speedometer
		)
		self.speed_needle.setObjectName("speed_needle")
		self.speed_needle.setGeometry(QRect(20, 8, 256, 256))
		self.speed_needle.setStyleSheet("background-color: transparent")
		self.speed_needle.setPixmap(QPixmap(":/needles/assets/needle.png"))
		...
		self.battery.setStyleSheet(
			" color: #ffffff; font-family: 'Lato',sans-serif; font-size: 14px; font-weight: bold; text-align: center; text-transform: uppercase;"
		)
		...
		self.flightmode.setObjectName("flightmode")
		self.flightmode.setMinimumSize(QSize(280, 0))
		self.flightmode.setStyleSheet(
			" color: #ffffff; font-family: 'Lato',sans-serif; font-size: 14px; font-weight: bold; text-align: center; text-transform: uppercase;"
		)
	...
	def retranslateUi(self, IndicatorsPage):
		IndicatorsPage.setWindowTitle(
			QCoreApplication.translate("IndicatorsPage", "Form", None)
		)
		self.vspeed_label.setText("")
		self.vspeed_needle.setText("")
		self.speed_text_2.setText(
			QCoreApplication.translate("IndicatorsPage", "00", None)
		)
		...
		self.xpos_label.setText(
			QCoreApplication.translate("IndicatorsPage", "X:", None)
		)
		self.ypos_label.setText(
			QCoreApplication.translate("IndicatorsPage", "Y:", None)
		)
		self.battery_label.setText(
			QCoreApplication.translate("IndicatorsPage", "Battery:", None)
		)
		self.flight_mode_label.setText(
			QCoreApplication.translate("IndicatorsPage", "Flight Mode:", None)
		)
