...
class Ui_MainWindow(object):
	def setupUi(self, MainWindow):
		...
		self.combobox_connectionstring.addItem("")
		self.combobox_connectionstring.addItem("")
		self.combobox_connectionstring.setObjectName("combobox_connectionstring")
		...
		self.combobox_connectionstring.setStyleSheet("")
		...
		self.frame_center.setStyleSheet("QFrame{background-color: rgb(40, 44, 52);}")
		...
		sizePolicy2.setHeightForWidth(
			self.btn_home_page.sizePolicy().hasHeightForWidth()
		)
		...
		self.btn_home_page.setStyleSheet(
			"\n"
			"QPushButton {	\n"
			"	border: none;\n"
			"	background-color: transparent;\n"
		...
		self.btn_indicators_page.setObjectName("btn_indicators_page")
		self.btn_indicators_page.setFont(font3)
		self.btn_indicators_page.setStyleSheet(
			"QPushButton {	\n"
			"	border: none;\n"
			"	background-color: transparent;\n"
			"}\n"
		...
		self.btn_targets_page.setObjectName("btn_targets_page")
		sizePolicy2.setHeightForWidth(
			self.btn_targets_page.sizePolicy().hasHeightForWidth()
		)
		self.btn_targets_page.setSizePolicy(sizePolicy2)
		self.btn_targets_page.setFont(font3)
		self.btn_targets_page.setStyleSheet(
			"QPushButton {	\n"
			"	border: none;\n"
			"	background-color: transparent;\n"
			"}\n"
		...
		icon = QIcon(QIcon.fromTheme("emblem-photos"))
	...
	def retranslateUi(self, MainWindow):
		MainWindow.setWindowTitle(QCoreApplication.translate("MainWindow", "GCS", None))
		self.btn_toggle_menu.setText("")
		self.label_title_bar_top.setText(
			QCoreApplication.translate("MainWindow", "UAV Ground Control Station", None)
		)
		self.combobox_connectionstring.setItemText(
			0, QCoreApplication.translate("MainWindow", "USB", None)
		)
		self.combobox_connectionstring.setItemText(
			1, QCoreApplication.translate("MainWindow", "Telemetri", None)
		)
		self.combobox_connectionstring.setItemText(
			2, QCoreApplication.translate("MainWindow", "SITL (UDP)", None)
		)
		self.combobox_connectionstring.setItemText(
			3, QCoreApplication.translate("MainWindow", "SITL (TCP)", None)
		)
		self.combobox_connectionstring.setItemText(
			4, QCoreApplication.translate("MainWindow", "TCP", None)
		)
		self.combobox_connectionstring.setItemText(
			5, QCoreApplication.translate("MainWindow", "UDP", None)
		)

		# if QT_CONFIG(tooltip)
		self.combobox_connectionstring.setToolTip(
			QCoreApplication.translate(
				"MainWindow",
				"<html><head/><body><p>Connection String</p></body></html>",
				None,
			)
		)
		# endif // QT_CONFIG(tooltip)
		self.combobox_baudrate.setItemText(
			0, QCoreApplication.translate("MainWindow", "128000", None)
		)
		self.combobox_baudrate.setItemText(
			1, QCoreApplication.translate("MainWindow", "115200", None)
		)
		self.combobox_baudrate.setItemText(
			2, QCoreApplication.translate("MainWindow", "57600", None)
		)
		self.combobox_baudrate.setItemText(
			3, QCoreApplication.translate("MainWindow", "38400", None)
		)
		self.combobox_baudrate.setItemText(
			4, QCoreApplication.translate("MainWindow", "19200", None)
		)
		self.combobox_baudrate.setItemText(
			5, QCoreApplication.translate("MainWindow", "14400", None)
		)
		self.combobox_baudrate.setItemText(
			6, QCoreApplication.translate("MainWindow", "9600", None)
		)

		# if QT_CONFIG(tooltip)
		self.combobox_baudrate.setToolTip(
			QCoreApplication.translate(
				"MainWindow", "<html><head/><body><p>Baud Rate</p></body></html>", None
			)
		)
		# endif // QT_CONFIG(tooltip)
		self.combobox_baudrate.setCurrentText(
			QCoreApplication.translate("MainWindow", "128000", None)
		)
		# if QT_CONFIG(tooltip)
		self.btn_connect.setToolTip(
			QCoreApplication.translate(
				"MainWindow", "<html><head/><body><p>Connect</p></body></html>", None
			)
		)
		# endif // QT_CONFIG(tooltip)
		...
		self.btn_home_page.setToolTip(
			QCoreApplication.translate(
				"MainWindow", "<html><head/><body><p>Home</p></body></html>", None
			)
		)
		# endif // QT_CONFIG(tooltip)
		self.btn_home_page.setText("")
		# if QT_CONFIG(tooltip)
		self.btn_indicators_page.setToolTip(
			QCoreApplication.translate(
				"MainWindow", "<html><head/><body><p>Indicators</p></body></html>", None
			)
		)
		# endif // QT_CONFIG(tooltip)
		self.btn_indicators_page.setText("")
		# if QT_CONFIG(tooltip)
		self.btn_targets_page.setToolTip(
			QCoreApplication.translate(
				"MainWindow", "<html><head/><body><p>Targets</p></body></html>", None
			)
		)
		# endif // QT_CONFIG(tooltip)
		self.btn_targets_page.setText("")
		self.label_credits.setText(
			QCoreApplication.translate("MainWindow", "Made by YTU", None)
		)
		self.label_version.setText(
			QCoreApplication.translate("MainWindow", "v0.7", None)
		)
