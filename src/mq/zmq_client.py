    ...
    def send_remote_command(self, command: str) -> str:
        ...
        try:
            ...
            if self._remote_timeout_count % 5 == 1:  # Log every 5th timeout
                self.log(
                    "Timeout waiting for response, resetting remote socket", "warning"
                )
    ...
    def send_command(self, command: str) -> str:
        ...
        try:
            ...
            if self._local_timeout_count % 5 == 1:  # Log every 5th timeout
                self.log(
                    "Timeout waiting for response, resetting local socket", "warning"
                )
