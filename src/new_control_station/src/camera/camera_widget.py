...
from PySide6.QtGui import QPixmap, QImage, QFont, QPainter, QPen, QBrush, QColor
...
class CameraWidget(QWidget):
    ...
    def show_placeholder(self):
        ...
        placeholder = QPixmap("./assets/images/placeholder.png")  # Path to your image asset
    ...
    def show_placeholder_fallback(self):
        """Show placeholder when camera is not connected"""
        ...
        painter.drawText(280, 300, "Disconnected")
    ...
    def update_frame(self, frame):
        ...
        if frame is not None:
            ...
            if self.is_recording and self.video_writer and self.pause_btn.text() == "Pause":
    ...
    def start_recording(self):
        ...
        try:
            ...
            self.recording_filename = os.path.join("recordings", f"drone_recording_{timestamp}.mp4")
    ...
    def stop_recording(self):
        ...
        self.pause_btn.setEnabled(False)
        self.recording_indicator.hide()
        self.status_label.setText("Recording Saved" if self.recording_filename else "Camera Connected")
