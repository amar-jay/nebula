...
class Ui_Form(object):
	def setupUi(self, Form):
		...
		self.label.setText("")
		self.label.setPixmap(QtGui.QPixmap(get_asset("images/background.jpg")))
		...
		self.label_2.setPixmap(QtGui.QPixmap(get_asset("images/logo.png")))
	...
	def retranslateUi(self, Form):
		...
		self.label_5.setText("Eposta")
		self.lineEdit_3.setPlaceholderText("example@marun.edu.tr")
		self.label_6.setText("Şifre")
		self.lineEdit_4.setPlaceholderText("••••••••••••")
		self.checkBox.setText("Beni hatırla")
		self.pushButton.setText("Giriş")
		self.pushButton_2.setText("Şifremi unuttum")
		# disable pushButton_2
